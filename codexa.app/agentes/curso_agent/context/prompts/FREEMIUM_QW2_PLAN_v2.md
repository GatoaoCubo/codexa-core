# FREEMIUM QW2: PLAN | O Planejador Universal

**ID**: FREEMIUM_QW2_PLAN_v2 | **Version**: 2.0.0 | **Created**: 2025-12-01
**Purpose**: Planejar execucao antes de agir - supervisao inteligente
**Compatibility**: ChatGPT, Claude, Gemini, Llama, Mistral (qualquer LLM)
**Core Concept**: SUPERVISAO - Pare de executar cego, comece a validar planos
...
Se voce tem dados ou prompts anteriores, cole DEPOIS do prompt usando labels:
...
| Campo | Valor |
|-------|-------|
| ID | FREEMIUM_QW2_PLAN_v2 |
| Versao | 2.0.0 |
| Criado | 2025-12-01 |
| Autor | CODEXA System |
| Tipo | Freemium Educational Content |
| Dominio | Universal (qualquer tarefa, qualquer industria) |
| Conceito Core | Supervisao |
| Anterior | FREEMIUM_QW1_META_PROMPT_v2.md |
| Proximo | FREEMIUM_QW3_IMPLEMENT_v2.md |
...
- ADD: Secao "SE VOCE VEIO DO META-PROMPT" para transicao
- ADD: Labels para dados [PROMPT], [PESQUISA], [ANUNCIO], [FOTO]
- ADD: Adaptacao automatica por complexidade
- ADD: Secao "APOS AJUSTE" explicando fluxo de iteracao
- ADD: Secao "PROXIMO PASSO" com transicao para IMPLEMENT
- FIX: Plano atualizado deve ser mostrado antes de executar
