...
GPT-5 by default tries to be thorough and comprehensive in its context gathering. Use prompts to be more prescriptive about how eager it should be, and whether it should parallelize discovery/tool calling.
