# SETUP GUIDE | Mentor Agent - Seu Guia Prático de E-commerce v1.0.0

**Universal setup instructions** for deploying Mentor Agent - Seu Guia Prático de E-commerce across different LLM platforms.
...
Ensure you have the complete `agentes\mentor_agent/` folder with:
...
2. Configure Assistant:
   ```yaml
   Name: Mentor Agent - Seu Guia Prático de E-commerce
   Model: gpt-4
...
3. Upload knowledge files to Vector Store:
   - Create new Vector Store: "Mentor Agent - Seu Guia Prático de E-commerce Knowledge Base"
   - Upload files:
     ```
     N/A
     N/A
...
2. Configure GPT:
   ```yaml
   Name: Mentor Agent - Seu Guia Prático de E-commerce
   Description: **Versão 2.0 - Sistema Consolidado de Conhecimento + Mentoria** Olá! Eu sou o Mentor Agent, seu conselheiro prático para vender mais nos marketplaces brasileiros (Mercado Livre, Shopee, Magalu, etc.). ---
   Instructions: [PASTE_INSTRUCTIONS_MD_CONTENT]
