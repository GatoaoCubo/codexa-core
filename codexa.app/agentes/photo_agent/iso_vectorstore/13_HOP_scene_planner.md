<!-- iso_vectorstore -->
<!--
  Source: 10_scene_planner_HOP.md
  Agent: photo_agent
  Synced: 2025-11-30
  Version: 2.0.0
...
**Input**: User request (subject + style + optional brand guidelines)
**Output**: 9-scene grid with defined shot types and configurations loaded
