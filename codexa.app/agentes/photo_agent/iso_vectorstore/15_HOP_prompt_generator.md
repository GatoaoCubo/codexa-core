<!-- iso_vectorstore -->
<!--
  Source: 30_prompt_generator_HOP.md
  Agent: photo_agent
  Synced: 2025-11-30
  Version: 2.0.0
...
- Phase 1 completed: 9-scene grid defined (angles, purposes, marketplace targets)
- Phase 2 completed: Camera specs + lighting design for all 9 scenes
- `config/pnl_triggers.json` loaded (psychological persuasion keywords)
- Photography style known (affects mood/descriptors)
- Product details clear (physical attributes, colors, materials)
- Target AI platform known (Midjourney, DALL-E 3, Stable Diffusion XL, etc.)
...
4. **Lighting Setup** (15-20 words):
   ...
   - Example: "Soft box front lighting, 5500K cool daylight, even illumination with no harsh shadows"

5. **Color Palette** (10-15 words):
   - Primary colors, accent colors, background
   - Example: "Pure white background, matte white mug, warm wood tones, gold accents"
