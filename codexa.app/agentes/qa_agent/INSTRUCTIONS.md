...
7. Verify redirect to {{SHOPIFY_DOMAIN}}
...
Test scenarios:
[
  { msg: "{{CHAT_TEST_1_INPUT}}", expect: products with "{{CHAT_TEST_1_EXPECT}}" },
  { msg: "{{CHAT_TEST_2_INPUT}}", expect: products with "{{CHAT_TEST_2_EXPECT}}" },
  { msg: "{{CHAT_TEST_3_INPUT}}", expect: products with "{{CHAT_TEST_3_EXPECT}}" },
  { msg: "{{CHAT_TEST_4_INPUT}}", expect: products with "{{CHAT_TEST_4_EXPECT}}" }
]

For each:
  1. POST to /functions/v1/{{AI_CHAT_FUNCTION}}
...
[FAIL] AI Chat - Scenario 3
       Expected: products with "{{CHAT_TEST_3_EXPECT}}"
