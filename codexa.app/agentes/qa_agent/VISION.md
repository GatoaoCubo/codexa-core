...
> **De**: Agente especifico por marca
...
```json
{
  "$schema": "https://qa-agent.example.dev/schema.json",
  "project": "{{PROJECT_NAME}}",
  "version": "1.0.0",

  "environments": {
    "production": "https://{{DOMAIN}}",
    "staging": "https://{{BASE_URL}}",
  ...
  "routes": [
    ...
    { "path": "/produto/:slug", "name": "Product", "critical": true, "samples": ["example-product"] },
...
# Projeto 2: Brand B
cd brand-b-ecommerce
qa run --env production
# Score: 87.1 (B+)

# Projeto 3: Brand C
cd brand-c-institucional
qa run --env production
# Score: 95.8 (A+)

# Dashboard consolidado
qa dashboard --projects brand-a,brand-b,brand-c
...
**Proximo passo**: Decidir se implementamos o framework ou se o agente atual atende as necessidades imediatas.
