...
│
└── [ARCHIVED] scout_agent + conhecimento_agent
    → Consolidated into mentor_agent (v2.0.0)
    → Use /prime-mentor for knowledge & code navigation
```
...
**Status**: ⚠️ Consolidated into mentor_agent v2.0.0 (2025-11-13)

**Legacy commands**: `/prime-scout`, `/scout`, `/prime-knowledge`, `/knowledge` (REMOVED)

**Use instead**: `/prime-mentor` (includes all scout + knowledge functionality)

**Location**: Features now in `mentor_agent/`
...
/prime-mentor       # Knowledge & mentoring specialist (includes scout + knowledge)
```
