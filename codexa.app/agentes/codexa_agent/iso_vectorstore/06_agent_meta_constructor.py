...
Usage:
    # Direct execution
    ./adws/adw_agent_meta_constructor.py "Create a sentiment analysis agent"

    # With specific model
    ./adws/adw_agent_meta_constructor.py "Build a code review agent" --model opus

    # With target directory
    ./adws/adw_agent_meta_constructor.py "Research agent" --target-dir agents/research-agent-v1

Examples:
    # Full meta-construction workflow
    ./adws/adw_agent_meta_constructor.py "Build an agent that analyzes financial reports and generates summaries"

    # With custom output
    ./adws/adw_agent_meta_constructor.py "Customer support agent" --output-dir custom-agents/
"""
