...
Features:
- Comprehensive doc validation (4 files per agent)
...
Usage:
    ...
    uv run validators/12_doc_sync_validator.py --all --output-dir reports/
"""
...
from config.paths import PATH_REGISTRY, AGENTS_ROOT
...
def main():
    ...
    if args.agents_dir:
        ...
        # Use centralized path from global orchestrator
