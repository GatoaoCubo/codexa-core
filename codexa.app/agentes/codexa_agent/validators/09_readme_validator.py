...
Features:
- Validates 8 required sections in README files
- Validates 6 required sections in /prime files
- Generates ##report (JSON + MD) following REPORT_STANDARD

Usage:
    python validators/09_readme_validator.py --scan-all
    python validators/09_readme_validator.py --file scripts/README.md
    python validators/09_readme_validator.py --scan-all --output-dir reports/
"""
...
from paths import CODEXA_AGENT_ROOT
