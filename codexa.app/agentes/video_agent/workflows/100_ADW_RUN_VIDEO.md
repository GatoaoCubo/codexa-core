...
```json
{
  "workflow_id": "adw_run_video",
  "workflow_name": "Complete Video Generation Workflow",
  "agent": "video_agent",
  "version": "2.0.0",
  ...
  "phases": [
    {"phase_id": "phase_0_knowledge", "phase_name": "Knowledge Loading", "duration": "1-2min", "module": "PHASE_0_KNOWLEDGE_LOADING", "task_hint": "video_creation"},
    {"phase_id": "preflight", "phase_name": "Pre-flight Validation", "duration": "~2s", "description": "Validate inputs and configure execution mode"},
    {"phase_id": "phase_1_concept", "phase_name": "Concept Generation", "duration": "~5s", "description": "Generate 6-8 shot storyboard with narrative arc"},
    {"phase_id": "phase_2_script", "phase_name": "Script Writing", "duration": "~3s", "description": "Write narration script with video_mode awareness"},
    {"phase_id": "phase_3_visual", "phase_name": "Visual Prompting", "duration": "~10s", "description": "Create platform prompts with composition mode awareness"},
    {"phase_id": "phase_4_production", "phase_name": "Video Production", "duration": "120-300s", "description": "Generate video clips via platform APIs"},
    {"phase_id": "phase_5_editing", "phase_name": "Final Editing", "duration": "~15s", "description": "Assemble final video with audio and text"},
    {"phase_id": "post_validation", "phase_name": "Post-Validation", "duration": "~5s", "description": "Validate final video quality with 11-point checklist"}
  ]
}
```
