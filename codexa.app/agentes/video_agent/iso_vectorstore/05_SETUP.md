# SETUP GUIDE | video_agent v2.5.0
...
- iso_vectorstore/ - 20 numbered knowledge files
- config/ - API configurations, voices, video modes
- prompts/ - 5 modular HOPs (one per stage)
- builders/ - 5 Python builders
- knowledge/ - Detailed platform and prompt engineering guides
